...
from peft.lora.ml_lora import MlLoraPool
...
class Attention(nn.Module):
    ...
    def forward(self, x, **kwargs):
        B, N, C = x.shape
        if 'lora' in kwargs:
            lora = kwargs['lora'](x, depth_id=kwargs['depth_id'], task_id=kwargs['task_id'], train=kwargs['train'], position='qkv')['lora_value']
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
            ...
            rank=4, lora_pool_size=10, attn=Attention, lora_pool = MlLoraPool, lora_depth=12,
            ...
            final_warmup=1500, beta1=0.85, beta2=0.85, total_step=3000):
        """
        Args:
