...
from peft.lora.ema_lora import EmaLoraPool
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
            ...
            rank=4, lora_pool_size=10, attn=Attention, lora_pool = EmaLoraPool, lora_momentum=None, lora_depth=None,
        ...
        if lora:
            self.lora_layer = lora_pool(pool_size=lora_pool_size, dim=embed_dim, rank=rank, depth=lora_depth, lora_momentum=lora_momentum,
    ...
    def get_lora_constrain_loss(self, args=None, device=None, dtype='l2'):

        return args.lora_reg * self.lora_layer.lora_constrain(device=device, dtype=dtype)
