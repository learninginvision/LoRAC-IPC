...
# from peft.lora.comp_ilora_save import CompILoraPool
# from peft.lora.comp_ilora_dw import CompILoraPool
...
class VisionTransformer(nn.Module):
    ...
    def get_loss_reg(self, task_id, device=None, args=None, dtype=None):
        return args.lora_reg * self.lora_layer.loss_reg(task_id=task_id, device=device, args=args, dtype=dtype)
    ...
    def after_task(self, task_id=-1, device=None, args=None):
        ...
        self.lora_layer.after_task(task_id, device, args=args)
