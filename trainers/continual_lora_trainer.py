...
def train(args):
    ...
    if args.eval:
        ...
        for task_id in range(args.num_tasks):
            ...
            _ = evaluate_till_now(model, data_loader, device,
                                  task_id, class_mask, acc_matrix, target_task_map=target_task_map, args=args, )
    ...
    train_and_evaluate(model, model_without_ddp, criterion, data_loader, optimizer, lr_scheduler, device, class_mask, target_task_map, args)
