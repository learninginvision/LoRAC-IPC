...
from engines.comp_adalora_single_engine import train_and_evaluate, evaluate_till_now, _compute_tii_mean, tii_mean, tii_cov, tii_shrink_cov
import vits.comp_lora_vision_transformer as comp_lora_vision_transformer
...
def train(args):
    ...
    args.adalora_total_step = args.epochs * len(data_loader[0]['train'])
    assert args.adalora_total_step > args.adalora_init_warmup + args.adalora_final_warmup, "Total step should be larger than the sum of init_warmup and final_warmup"
    ...
    model = create_model(args.model,
                         ...
                         lora_pool=CompAdaLoraPool,
                         target_rank=args.target_rank, 
                         init_warmup=args.adalora_init_warmup, 
                         final_warmup=args.adalora_final_warmup, 
                         mask_interval=args.adalora_mask_interval, 
    ...
    args.first_session_lr = args.first_session_lr * global_batch_size / 256.0
    ...
    if args.first_session_lr:
        base_params = {'params': base_params, 'lr': args.first_session_lr, 'weight_decay': args.weight_decay}
        base_omega_params = {'params': base_omega_params, 'lr': args.first_session_lr * args.omega_lr_scale, 'weight_decay': args.weight_decay}
    else:
