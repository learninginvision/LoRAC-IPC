...
from engines.comp_lora_warm_engine import train_and_evaluate, evaluate_till_now
...
def train(args):
    ...
    # if args.lora_qkv == "TTT":
    s2b_map = {'T':True, 'F':False}
    args.lora_qkv = [s2b_map[args.lora_qkv[0]], s2b_map[args.lora_qkv[1]], s2b_map[args.lora_qkv[2]]]
    ...
    if args.eval:
        ...
        for task_id in range(args.num_tasks):
            ...
            _ = evaluate_till_now(model, data_loader, device, task_id, class_mask, acc_matrix, args, )
