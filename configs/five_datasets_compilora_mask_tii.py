...
def get_args_parser(subparsers):
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default='/data/ling/ViT_CL_LORA/datasets/five_datasets/', type=str, help='dataset path')
    ...
    subparsers.add_argument('--output_dir', default='./output/5-datasets', help='path where to save, empty for no saving')
    ...
    subparsers.add_argument('--batch_wise', action='store_true', help='whether to use batch-wise in testing stage')
    ...
    # lora parameters
    subparsers.add_argument('--lora_type', default='compi', choices=['continual', 'comp', 'compi'],type=str, help='lora type')
    subparsers.add_argument('--lora_qkv', default='FFF', type=list, help='lora qkv')
    subparsers.add_argument('--lora_out', action="store_true", help='lora out')
    subparsers.add_argument('--lora_fc1', action="store_true", help='lora fc1')
    subparsers.add_argument('--lora_fc2', action="store_true", help='lora fc2')
    subparsers.add_argument('--omega_lr_scale', default=1.0, type=float, help='lora lr scale')
    ...
    subparsers.add_argument('--ortho', default=1.0, type=float, help='orthogonal regularization lambda')
    subparsers.add_argument('--lora_depth', default=12, type=int, help='lora depth')

    # adaptive lora parameters
    subparsers.add_argument('--ilora_beta1', default=0.85, type=float, help='beta1 for adaptive lora')
    subparsers.add_argument('--ilora_beta2', default=0.85, type=float, help='beta2 for adaptive lora')
    
    # ipc parameters
    subparsers.add_argument('--new_mask', action='store_true', help='whether to use new_mask')
    subparsers.add_argument('--threshold', default=0.1, type=float, help='choose important position')
    
    
    subparsers.add_argument('--use_replay', action='store_true', help='whether to use replay')
    
    # task id inference parameters
    ...
    subparsers.add_argument('--first_session_lr', default=0.0, type=float)
