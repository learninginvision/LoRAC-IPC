...
def get_args_parser(subparsers):
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default='/data/ling/CL_ViT_DT/datasets/CIFAR100/', type=str, help='dataset path')
    ...
    subparsers.add_argument('--threshold', default=0.05, type=float, help='choose important position')
