...
def get_args_parser(subparsers):
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default='/data/ling/ViT_CL_LORA_10/datasets/ImageNet-R/', type=str, help='dataset path')
    ...
    subparsers.add_argument('--omega_lr_scale', default=0.0005, type=float, help='lora lr scale')
