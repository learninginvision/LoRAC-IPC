        ...
        for attr_name in self.attributes:
            ...
            if cond:
                for end in ['_A', '_B']:
                    ...
                    print(f'{name} IPT: {self.ipt[name][task_id]}', f'{name} EXP_AVG_IPT: {self.exp_avg_ipt[name][task_id]}', f'{name} EXP_AVG_UNC: {self.exp_avg_unc[name][task_id]}')
        ...
        if task_id < self.pool_size:
            ...
            for attr_name in self.attributes:
                ...
                if cond:
                    ...
                    print(f"{attr_name} A_IPT: {lora_A_ipt_score.mean(dim=(1, 2), keepdim=True).reshape(-1)}", f"{attr_name} B_IPT: {lora_B_ipt_score.mean(dim=(1, 2), keepdim=True).reshape(-1)}")
